...
class FlexibleSEV:
    ...
    """
    def __init__(self, model, data_encoder, X_col, X_neg, tol=0.2, k=5, strict=None):
        self.model = model
        ...
        for index in range(100):
            index = index % len(self.data_encoder.original_columns)
            feature = self.data_encoder.original_columns[index]
            if self.data_encoder.columns_types[feature] == "numerical":
                ...
                for value in quantile_dict[feature]:
                    ...
                    flexible_mean_temp = self.final_flexible_mean.copy()
            ...
            if prev_choice == choice-1:
                ...
                for comb in combs:
                    ...
                    try:
                        ...
                        score = self.model.predict_proba(self.flexible_transform(Xi, pointer))[0, 1]
                    # for counterfactual the score should be negative
                    if mode == "minus":
                        if score < 0.5:
